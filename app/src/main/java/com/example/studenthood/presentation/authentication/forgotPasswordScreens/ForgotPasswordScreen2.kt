package com.example.studenthood.presentation.authentication.forgotPasswordScreens
...
@Composable
fun ForgotPasswordPage2(navController: NavHostController) {
...
fun ForgotPasswordPagePreview(){
    //ForgotPasswordPage2(rememberNavController())
