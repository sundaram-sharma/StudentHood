package com.example.studenthood.presentation.main.jobSearch
...
@Composable
fun JobSearchPage(navController: NavHostController) {
...
@Composable
@Preview
fun JobSearchPagePreview(){
    JobSearchPage(rememberNavController())
}